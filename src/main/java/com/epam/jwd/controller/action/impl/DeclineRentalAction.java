...
public class DeclineRentalAction implements Action {
    private static final Logger LOGGER = LoggerFactory.getLogger(DeclineRentalAction.class);
    private final RentalService rentalService;
    private final UserService userService;

    public DeclineRentalAction() {
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response)
        ...
        LOGGER.debug("Decline rental action received");
