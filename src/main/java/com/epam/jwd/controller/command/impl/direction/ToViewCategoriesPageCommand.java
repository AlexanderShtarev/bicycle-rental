...
public class ToViewCategoriesPageCommand implements Command {
    ...
    public ViewResolver resolve(HttpServletRequest request, HttpServletResponse response)
        ...
        LOGGER.debug("To view categories command received");
        return new ViewResolver(PageConstant.CATEGORIES_VIEW);
    }
